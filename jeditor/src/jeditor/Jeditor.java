...
public class Jeditor {
	public static void main(String[] args) {
		resources = ResourceBundle.getBundle("examples_texteditor");  //$NON-NLS-1$
	...
	public Jeditor(Display display) {
		open(display);
	}
	...
	void loadProfile(int profile) {
		try {
			switch (profile) {
				case 1: {
					String text = openFile(Jeditor.class.getResourceAsStream("text.txt"));  //$NON-NLS-1$
					StyleRange[] styles = getStyles(Jeditor.class.getResourceAsStream("styles.txt"));  //$NON-NLS-1$
				...
				case 3: {
					String text = openFile(Jeditor.class.getResourceAsStream("text4.txt"));  //$NON-NLS-1$
					styledText.setText(text);
					break;
				}
				case 4: {
